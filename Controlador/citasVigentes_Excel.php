<?php
	...
	$objPHPExcel->getProperties()->setCreator("Natalia Agudelo")->setDescription("Reporte de citas vigentes");
	
	//Establecemos la pestaña activa y nombre a la pestaña
	$objPHPExcel->setActiveSheetIndex(0);
	$objPHPExcel->getActiveSheet()->setTitle("Citas_vigentes");
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B3', 'REPORTE DE CITAS VIGENTES');
	$objPHPExcel->getActiveSheet()->mergeCells('B3:D3');
            ...
            header('Content-Disposition: attachment;filename="citas_vigentes.xlsx"');
